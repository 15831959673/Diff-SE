...
def train(file, i=None):
    ...
    generate_data = np.squeeze(np.load(f'../diff/generat_pos{i}.npz')['reslut'])
...
if __name__ == "__main__" :
    ...
    # )
    logging.basicConfig(
        filename=f'diffmodel/mESC/generate_result.log',
        filemode='w',
        format='%(asctime)s - %(levelname)s - %(message)s',
        level=logging.INFO
    )
