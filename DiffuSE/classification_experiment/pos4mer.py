...
if __name__ == '__main__':
    ...
    data_dict2 = {'mESC': x1[1][x1[4] == 1], 'myotube': x2[1][x2[4] == 1], 'macrophage': x3[1][x3[4] == 1],
                  'proB-cell': x4[1][x4[4] == 1],
                  'Th-cell': x5[1][x5[4] == 1], 'H2171': x6[1][x6[4] == 1], 'U87': x7[1][x7[4] == 1],
                  'MM1.S': x8[1][x8[4] == 1]}

    data_dict3 = {'mESC': x1[2][x1[4] == 1], 'myotube': x2[2][x2[4] == 1], 'macrophage': x3[2][x3[4] == 1],
                  'proB-cell': x4[2][x4[4] == 1],
                  'Th-cell': x5[2][x5[4] == 1], 'H2171': x6[2][x6[4] == 1], 'U87': x7[2][x7[4] == 1],
                  'MM1.S': x8[2][x8[4] == 1]}

    data_dict4 = {'mESC': x1[3][x1[4] == 1], 'myotube': x2[3][x2[4] == 1], 'macrophage': x3[3][x3[4] == 1],
                  'proB-cell': x4[3][x4[4] == 1],
                  'Th-cell': x5[3][x5[4] == 1], 'H2171': x6[3][x6[4] == 1], 'U87': x7[3][x7[4] == 1],
                  'MM1.S': x8[3][x8[4] == 1]}
